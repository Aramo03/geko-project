...
if ENV_FILE.exists():
    ...
    raise ImproperlyConfigured(
        f'Missing {ENV_FILE}. Copy .env.example or create .env with DB_* and EMAIL_* variables.'
    )
...
# Local fallback: the bundled dump is PostgreSQL, but this machine's
# postgres password does not match the backup .env. SQLite lets the app run.
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3',
        'NAME': BASE_DIR / 'db.sqlite3',
